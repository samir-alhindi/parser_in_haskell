...
/* package my-expression-parser-0.1.0.0 */
#ifndef VERSION_my_expression_parser
#define VERSION_my_expression_parser "0.1.0.0"
#endif /* VERSION_my_expression_parser */
#ifndef MIN_VERSION_my_expression_parser
#define MIN_VERSION_my_expression_parser(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_my_expression_parser */
...
#define CURRENT_COMPONENT_ID "my-expression-parser-0.1.0.0-inplace-sfl-interpreter"

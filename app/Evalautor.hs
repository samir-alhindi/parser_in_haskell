...
eval (Binary opp e1 e2) envi
    ...
    where
        ...
        relational
            ...
            | otherwise = Left (Error "This will never run.")
        ...
        bind = do
            ...
            case f of
                ...
                _ -> Left (Error ("Left opperand must be a callable and not of type " ++ (type_of f)))
...
eval (Unary opp e) envi = case opp of
